...
$txt['coppa_no_consent'] = 'Администратор ещё не получил согласия на вашу регистрацию от родителей/опекуна.';
...
$txt['setting_coppaPost'] = 'Имейл, на который должно быть прислано одобрение о разрешении регистрации';
...
$txt['admin_register_email'] = 'Имейл';
...
// argument(s): $context['forum_name_html_safe']
$txt['coppa_form_title'] = 'Форма одобрения для регистрации на %1$s';
$txt['coppa_form_address'] = 'Адрес';
$txt['coppa_form_date'] = 'Дата';
// argument(s): $context['forum_name_html_safe']
$txt['coppa_form_body'] = 'Я, {PARENT_NAME},<br><br> разрешаю {CHILD_NAME} (имя ребенка) зарегистрироваться на форуме: %1$s, с именем пользователя: {USER_NAME}.<br><br>Я понимаю, что введенная личная информация {USER_NAME} может быть показана другим пользователям форума.<br><br>Подпись:<br>{PARENT_NAME} (Родитель/Опекун).';
...
$txt['registration_username_unavailable'] = 'Имя пользователя недоступно';
