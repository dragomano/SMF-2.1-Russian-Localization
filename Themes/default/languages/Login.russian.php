...
$txt['coppa_after_registration'] = 'Спасибо за регистрацию на форуме ' . $context['forum_name_html_safe'] . '.<br><br>Так как тебе меньше {MINIMUM_AGE} лет, мы должны получить от твоих родителей или опекунов разрешение использовать этот форум. Чтобы активировать учётную запись, пожалуйста, распечатай эту форму:';
