...
$txt['welcome_guest_activate'] = '<br>Не получили <a href="%1$s?action=activate">письмо для активации учётной записи</a>?';
...
$txt['secret_auth_missing'] = 'Невозможно установить secret_auth в Settings.php, это ослабляет вашу безопасность и подвергает вашу систему риску для атак.';
...
$txt['unsubscribe_announcements_plain'] = 'Чтобы отписаться от рассылки форума, объявлений и важных оповещений, перейдите по этой ссылке:<br>%1$s';
