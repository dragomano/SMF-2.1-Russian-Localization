...
$txt['pm_actions_filter_by_label'] = 'Фильтровать по меткам';
$txt['pm_actions_go'] = 'Отправить';

// Manage Labels Screen.
$txt['pm_apply'] = 'Принять';
$txt['pm_manage_labels'] = 'Управление метками';
$txt['pm_labels_delete'] = 'Хотите удалить выделенные метки?';
$txt['pm_labels_desc'] = 'Здесь можно добавлять, редактировать и удалять метки для своих личных сообщений.';
$txt['pm_label_add_new'] = 'Добавить новую метку';
$txt['pm_label_name'] = 'Имя метки';
$txt['pm_labels_no_exist'] = 'У вас нет созданных меток!';

// Labeling Drop Down.
$txt['pm_current_label'] = 'Метка';
$txt['pm_msg_label_title'] = 'Изменить метки';
$txt['pm_msg_label_apply'] = 'Добавить метку';
$txt['pm_msg_label_remove'] = 'Убрать метку';
$txt['pm_msg_label_inbox'] = 'Входящие';
$txt['pm_sel_label_title'] = 'Метки для выделенных';
...
$txt['pm_search_between'] = 'от';
$txt['pm_search_between_and'] = 'до';
...
$txt['pm_search_results_info'] = 'Найдено %1$d совпадающих сообщений в %2$s.';

$txt['pm_search_orderby_relevant_first'] = 'Подходящие первыми';
$txt['pm_search_orderby_recent_first'] = 'Недавние первыми';
$txt['pm_search_orderby_old_first'] = 'Старые первыми';

$txt['pm_visual_verification_label'] = 'Визуальная проверка';
$txt['pm_visual_verification_desc'] = 'Пожалуйста, введите код на изображении, чтобы отправить личное сообщение.';
...
$txt['pm_rule_label'] = 'Поставить метку';
$txt['pm_rule_sel_label'] = 'Выберите метку';
$txt['pm_rule_delete'] = 'Удалить сообщение';
$txt['pm_rule_no_name'] = 'Вы забыли ввести название фильтра.';
...
$txt['pm_readable_and'] = 'и';
$txt['pm_readable_or'] = 'или';
...
$txt['pm_readable_label'] = 'поставить метку «{LABEL}»';
$txt['pm_readable_delete'] = 'удалить сообщение';
$txt['pm_readable_then'] = 'тогда';
