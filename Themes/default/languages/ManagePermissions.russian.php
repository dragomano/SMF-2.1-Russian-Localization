...
$txt['permissionhelp_profile_signature'] = 'Позволяет пользователям редактировать подпись в своих профилях.';
...
$txt['permissionhelp_profile_forum'] = 'Позволяет пользователям редактировать свои профили.';
$txt['permissionname_profile_forum_own'] = 'Свой профиль';
$txt['permissionname_profile_forum_any'] = 'Любой профиль';
$txt['permissionname_profile_website'] = 'Редактирование полей «Название сайта» и «URL-адрес сайта»';
$txt['permissionhelp_profile_website'] = 'Позволяет пользователям редактировать содержимое полей «Название сайта» и «URL-адрес сайта» в своих профилях.';
...
$txt['permissionhelp_profile_blurb'] = 'Позволяет пользователям редактировать подпись под аватаром в своих профилях.';
...
$txt['permissionhelp_view_mlist'] = 'Список пользователей показывает всех пользователей, зарегистрированных на форуме. К списку могут быть применены сортировка и поиск. Список пользователей доступен с главной страницы и со страницы со статистикой форума. Кроме того, страницы групп пользователей являются мини-списками пользователей, входящих в них.';
...
$txt['permissionhelp_calendar_view'] = 'Для каждого месяца года в календаре отображаются дни рождения, праздники или соответствующие события. Эти права доступа дают возможность просматривать календарь. При наличии данных прав пользователи увидят кнопку &laquo;Календарь&raquo; в главном меню форума. Не забудьте включить функцию календаря в настройках форума (Форум => Календарь).';
...
$txt['permissionhelp_calendar_edit'] = 'Событие — это дата, связанная с определенной датой или диапазоном дат. Любое событие можно отредактировать, нажав на красную звездочку (*) рядом с ним. Для этого пользователь должен иметь право на редактирование первого сообщения в соответствующей теме.';
...
$txt['permissionhelp_manage_boards'] = 'Эти права доступа позволяют пользователям создавать, редактировать и удалять разделы и категории на форуме.<br><br>Пользователи с этим правом могут видеть все разделы.';
...
$txt['permissionhelp_manage_smileys'] = 'Эти права доступа позволяют пользователям управлять смайликами форума.';
...
$txt['permissionhelp_manage_bans'] = 'Это право позволяет пользователям редактировать список банов. Есть возможность очищать журнал попыток обращения к форуму от забаненных пользователей.';
...
$txt['permissionname_profile_password'] = 'Изменение пароля или секретного вопроса';
...
$txt['permissionname_make_sticky'] = 'Закрепление тем';
$txt['permissionhelp_make_sticky'] = 'Это право позволяет пользователям закреплять темы.';
...
$txt['permissionhelp_modify'] = 'Это право позволяет пользователям редактировать сообщения — любые или только свои, в зависимости от настроек.';
...
$txt['permissionname_likes_like'] = 'Оценка контента с помощью лайков';
$txt['permissionhelp_likes_like'] = 'Позволяет пользователям оценивать любой контент (кроме созданного ими самими).';

$txt['permissiongroup_mentions'] = 'Упоминания';
$txt['permissionname_mention'] = 'Упоминание других пользователей через @ник';
$txt['permissionhelp_mention'] = 'Позволяет упоминать других пользователей в своих сообщениях, используя запись вида <strong>@ник</strong>. Например, пользователя Jack можно упомянуть, написав в сообщении «@Jack» (без кавычек). Упомянутым пользователям приходит сообщение (если включена соответствующая опция в настройках уведомлений).';
...
$txt['permissiongroup_bbc'] = 'Форумные теги';
$txt['permissionname_bbc'] = 'Использование тега [%1$s]';
$txt['permissionhelp_bbc_html'] = 'Это разрешение позволяет пользователям использовать тег [html] для встраивания любых HTML-тегов в сообщения, личные сообщения&nbsp;и&nbsp;т.&nbsp;д.<br><br><strong>Встраивание произвольного HTML может сломать ваш сайт и создать серьезные риски для безопасности. <u>Никому не предоставляйте это разрешение, если не доверяете этому человеку полностью!</u></strong>';
$txt['permissionnote_bbc_html'] = 'Создает угрозу безопасности!';
