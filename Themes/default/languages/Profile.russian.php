...
$txt['display_name_desc'] = 'Будет отображаться другим пользователям.';
...
$txt['password_strength'] = 'Рекомендуется использовать не менее 6 символов, с использованием комбинации букв, цифр и спецсимволов.';
$txt['include_website_url'] = 'Название вашего сайта или форума.';
$txt['complete_url'] = 'Полный URL-адрес вашего сайта или форума (например: <em>https://www.mypage.com</em>)';
$txt['sig_info'] = 'Этот текст будет отображаться под каждым вашим сообщением.<br>Для оформления можно использовать теги форума и смайлики.';
...
$txt['required_security_reasons'] = 'Введите, если необходимо изменить данные.';
...
$txt['custom_title'] = 'Пользовательский заголовок';

$txt['lastLoggedIn'] = 'Последняя активность';

$txt['alert_purge'] = 'Удалить все прочитанные оповещения';
...
$txt['auto_notify'] = 'Включить уведомление сразу после создания новой темы, либо после ответа в другой теме';
...
$txt['forumProfile_info'] = 'На этой странице можно изменить информацию о себе. Эти сведения будут отображаться на %1$s.<br>Если не считаете необходимым указывать какие-либо данные — просто пропустите их.';
...
$txt['ignoreboards'] = 'Игнор разделов';
...
$txt['user_email'] = 'Имя пользователя или имейл';
...
$txt['show_online'] = 'Отображать ваш онлайн-статус?';
...
$txt['calendar_default_view'] = 'Оформление страницы календаря';
$txt['calendar_viewlist'] = 'В виде списка';
$txt['calendar_viewmonth'] = 'В виде месяцев';
$txt['calendar_viewweek'] = 'В виде недели';
...
$txt['show_posts_none'] = 'Сообщений нет.';
$txt['show_topics_none'] = 'Пользователь ещё не создал ни одной темы.';
$txt['unwatched_topics_none'] = 'Непросмотренных тем нет.';
$txt['show_attachments_none'] = 'Вложений нет.';
...
$txt['profile_error_signature_disabled_bbc'] = 'В подписи нельзя использовать следующие форумные теги: %1$s';
...
$txt['tfa_profile_desc'] = 'Двухфакторная аутентификация позволяет улучшить безопасность, назначив отдельное устройство, без которого никто не сможет войти в ваш аккаунт, даже если у него есть ваши логин и пароль';
...
$txt['tfa_forced_desc'] = 'Администратор принудительно включил двухфакторную аутентификацию для всех аккаунтов. Пожалуйста, включите её и здесь тоже, для продолжения.';
...
$txt['cannot_disable_tfa'] = 'Двухфакторную аутентификацию отключить нельзя, так как она требуется для всех учётных записей.';
...
$txt['export_outdated_warning'] = 'Этот экспорт устарел. В нем отсутствуют ваши самые последние данные следующих типов:';
$txt['export_file_count'] = 'Файлов: %1$d.';
$txt['export_download_all'] = 'Скачать все';
