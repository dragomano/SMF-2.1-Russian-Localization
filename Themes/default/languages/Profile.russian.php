...
$txt['forumProfile_info'] = 'На этой странице можно изменить информацию о себе. Эти сведения будут отображаться на %1$s.<br>Если не считаете необходимым указывать какие-либо данные &mdash; просто пропустите их.';
