...
$txt['getProfileData'] = 'Скачивание профиля';
$txt['profileDataCenter'] = 'Центр скачивания профилей';
$txt['profileDownloadProfile_own'] = 'Скачать данные профиля вашего аккаунта';
$txt['profileDownloadProfile_any'] = 'Скачать данные профиля аккаунта %1$s';
$txt['profileDownloadMessages_own'] = 'Скачать сообщения вашего аккаунта';
$txt['profileDownloadMessages_any'] = 'Скачать сообщения аккаунта %1$s';
$txt['profileDownloadPMessages_own'] = 'Скачать личные сообщения вашего аккаунта';
$txt['profileDownloadPMessages_any'] = 'Скачать личные сообщения аккаунта %1$s';
$txt['profileDownload'] = 'Скачать';
$txt['profileDataNotFound'] = 'Выбор возвращает нулевые наборы данных';

$txt['getPolicyData'] = 'Просмотр политики';
$txt['policyOvervie'] = 'Обзор политики';
$txt['policy_approved'] = 'Утвержденная политика';
$txt['policy_new'] = 'Новая политика';
$txt['policyAccept'] = 'Принять политику';
$txt['policyNoApprved'] = 'Непринятая политика';
