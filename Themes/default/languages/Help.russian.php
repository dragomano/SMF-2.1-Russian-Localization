...
$helptxt['enableSpellChecking'] = 'Включить проверку орфографии. На сервере ДОЛЖНЫ быть установлены библиотеки pspell или enchant. Ваш сервер ' . ((function_exists('pspell_new') || function_exists('enchant_broker_init')) ? 'ПОДДЕРЖИВАЕТ' : 'НЕ ПОДДЕРЖИВАЕТ') . ' эту функцию.';
