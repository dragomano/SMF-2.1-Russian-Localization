...
$helptxt['requireAgreement'] = 'Этот параметр рекомендуется включить, чтобы соответствовать правилам <a href="https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules_en" class="bbc_link" rel="noopener">GDPR</a>.';
// The GDPR page of the EU exists in several languages; change the language code at the end of the url
$helptxt['requirePolicyAgreement'] = 'Этот параметр рекомендуется включить, чтобы соответствовать правилам <a href="https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules_en" class="bbc_link" rel="noopener">GDPR</a>.';
