...
$helptxt['user_limit'] = 'Эта опция ограничивает количество баллов, которые модератор может добавить/удалить конкретному пользователю в течение 24 часов. Используется для ограничения действий модератора за небольшой промежуток времени. Отключается установкой нулевого значения. Примечание: не влияет на пользователей с правами администраторов.';

$helptxt['error_log'] = '<strong>Журнал ошибок</strong><br>
	Здесь отображается каждая ошибка, с которой столкнулись пользователи при использовании форума. Ошибки сортируются по дате, можно выбрать сортировку, нажав на чёрной стрелке напротив каждой даты. Кроме того, можно отфильтровать ошибки, нажав на изображении рядом с каждой ошибкой. Это
...
$helptxt['allow_disableAnnounce'] = 'Это разрешит пользователям не получать уведомления об анонсируемых темах (когда устанавливается флажок «Объявление темы»).';
...
$helptxt['enableSpellChecking'] = 'Включить проверку орфографии. На сервере ДОЛЖНЫ быть установлены библиотеки pspell или enchant. %1$s';
// is conditionally used as part of $helptxt['enableSpellChecking']
$helptxt['enableSpellCheckingSupported'] = 'Ваш сервер ПОДДЕРЖИВАЕТ эту функцию.';
// is conditionally used as part of $helptxt['enableSpellChecking']
$helptxt['enableSpellCheckingUnsupported'] = 'Ваш сервер НЕ ПОДДЕРЖИВАЕТ эту функцию.';
...
$helptxt['disableRegisterCheck'] = 'Если этот параметр отключен, это позволит нескольким людям регистрироваться с одного устройства.';
...
$helptxt['requireAgreement'] = 'Этот параметр должен быть включен, чтобы соответствовать правилам <a href="https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules_en" class="bbc_link" rel="noopener">GDPR</a>.';
$helptxt['requirePolicyAgreement'] = 'Этот параметр должен быть включен, чтобы соответствовать правилам <a href="https://ec.europa.eu/commission/priorities/justice-and-fundamental-rights/data-protection/2018-reform-eu-data-protection-rules_en" class="bbc_link" rel="noopener">GDPR</a>.';
