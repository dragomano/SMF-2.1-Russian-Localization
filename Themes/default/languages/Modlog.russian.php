...
$txt['modlog_ac_sticky'] = 'Закреплена тема «{topic}»';
...
$txt['modlog_remove_all_confirm'] = 'Хотите очистить журнал полностью?';
$txt['modlog_go'] = 'Поиск';
...
$txt['modlog_admin_log_gdpr_no_delete'] = '<strong>Обратите внимание:</strong> записи об обновлении регистрационного соглашения и политики конфиденциальности не могут быть удалены из этого журнала, пока включена защита персональных данных в соответствии с GDPR.';
