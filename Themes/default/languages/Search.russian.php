...
$txt['search_orderby_large_first'] = 'Темы с большим количеством ответов первыми';
$txt['search_orderby_small_first'] = 'Темы с меньшим количеством ответов первыми';
...
$txt['search_weight_sticky'] = 'Релевантность поиска по закрепленным темам';

$txt['search_settings_desc'] = 'Здесь можно изменять обычные настройки поиска.';
$txt['search_settings_title'] = 'Настройка поиска';

$txt['search_weights_desc'] = 'Здесь можно изменять индивидуальные компоненты оценки релевантности поиска.';
...
$txt['search_example'] = '<em>Например: </em> &laquo;Доктор Хаус&raquo; — сериал';
...
$txt['spider_mode_note'] = 'Помните, что запись в журнал каждого действия ботов происходит только при установке уровня отслеживания на «Высокий» или «Очень высокий». Детализация каждого действия ботов записывается в журнал только при установке уровня отслеживания на «Очень высокий».';
...
$txt['spider_settings_desc'] = 'В данном разделе можно изменить настройки отслеживания поисковых систем.<br>Обратите внимание: если хотите настроить автоматическую чистку журналов, то настройки можно изменить <a href="%1$s">здесь</a>.';

$txt['spider_group'] = 'Назначить группу для ботов <div class="smalltext">Даёт возможность ограничить доступ ботов к некоторым разделам.</div>';
$txt['spider_group_note'] = 'Чтобы запретить ботам индексировать некоторые страницы.';
$txt['spider_group_none'] = 'Запрещено';

$txt['show_spider_online'] = 'Отображение ботов в списке &laquo;Кто онлайн&raquo;';
$txt['show_spider_online_no'] = 'Ни для кого';
$txt['show_spider_online_summary'] = 'Показывать количество ботов';
$txt['show_spider_online_detail'] = 'Показывать детали о ботах';
$txt['show_spider_online_detail_admin'] = 'Показывать всю инфу, но только админам';

$txt['spider_name'] = 'Название бота';
...
$txt['spiders_add'] = 'Добавить нового бота';
$txt['spiders_edit'] = 'Изменить бота';
$txt['spiders_remove_selected'] = 'Удалить выделенных ботов';
$txt['spider_remove_selected_confirm'] = 'Хотите удалить этих ботов?\\n\\nВся статистика также будет удалена!';
$txt['spiders_no_entries'] = 'Ни одного бота не добавлено.';

$txt['add_spider_desc'] = 'На этой странице можно редактировать параметры поисковых ботов. Если User-agent / IP-адрес гостя будет совпадать с введенными ниже, то он будет опознан как бот поисковой системы и его действия будут записаны согласно настройкам форума.';
$txt['spider_name_desc'] = 'Имя бота, под которым он будет записан.';
$txt['spider_agent_desc'] = 'User-agent, связанный с этим ботом.';
$txt['spider_ip_info_desc'] = 'Список IP-адресов, связанных с этим ботом.';

$txt['spider'] = isset($_REQUEST['sa']) && $_REQUEST['sa'] == 'logs' ? 'Бот' : '';
$txt['spider_time'] = 'Время';
$txt['spider_viewing'] = 'Активность';
$txt['spider_logs_empty'] = 'Записей не найдено.';
$txt['spider_logs_info'] = 'Обратите внимание, что регистрация всех действий бота будет записываться только при установке «высокого» или «очень высокого» уровня слежения. Детализация по всем действиям будет производиться только при «очень высоком» уровне слежения.';
$txt['spider_disabled'] = 'Запрещено';
$txt['spider_log_empty_log'] = 'Очистить журнал';
$txt['spider_log_empty_log_confirm'] = 'Хотите очистить журнал полностью?';
...
$txt['spider_stats_delete_older'] = 'Удалить всю статистику ботов, которые не посещали форум в течение %1$s дней.';
...
$txt['spider_stats_no_entries'] = 'На данный момент нет статистики по посещениям ботов.';
