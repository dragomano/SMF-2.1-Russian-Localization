...
$txt['spider_settings_desc'] = 'В данном разделе можно изменить настройки отслеживания поисковых систем. Обратите внимание: если хотите настроить автоматическую чистку журналов, то настройки можно изменить <a href="%1$s">здесь</a>.';
