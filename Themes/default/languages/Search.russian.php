...
$txt['spider_mode_note'] = 'Помните, что запись в журнал каждого действия пауков происходит только при установке уровня отслеживания в «Высокий» или «Очень высокий». Детализация каждого действия пауков записывается в журнал только при установке уровня отслеживания в «Очень высокий».';
