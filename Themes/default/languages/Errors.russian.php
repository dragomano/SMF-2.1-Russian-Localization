...
$txt['cannot_profile_title_any'] = 'Вы не можете редактировать пользовательские заголовки пользователей.';
...
$txt['registration_agreement_missing'] = 'Файл с регистрационным сообщением agreement.txt отсутствует или пустой. Регистрация будет отключена, пока это не будет исправлено';
