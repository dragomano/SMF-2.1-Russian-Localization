...
$txt['mc_warning_template_desc'] = 'Используйте эту страницу для заполнения детальной информации о шаблоне. Помните, что поле «Заголовок шаблона» не является частью шаблона. Помните, что уведомление отсылается в системе личных сообщений с использованием ББ-тегов, которые не описываются в шаблоне. Помните, что если используете переменную {MESSAGE}, то этот шаблон будет недоступен при использовании общих предупреждений (предупреждения не включаются в текст сообщения).';
