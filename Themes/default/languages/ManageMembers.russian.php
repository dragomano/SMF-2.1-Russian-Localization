...
$txt['membergroups_description'] = 'Группы пользователей имеют определенные параметры и права доступа. Членство в некоторых группах зависит от количества сообщений. Нужная группа назначается в профиле пользователя, в настройках учётной записи.';
...
$txt['admin_browse_filter_type_5'] = 'Неодобренные учётные записи несовершеннолетних';
