...
$txt['signature_settings_warning'] = 'Обратите внимание, что по умолчанию эти настройки не применяются к уже существующим подписям. <a href="%3$s?action=admin;area=featuresettings;sa=sig;apply;%2$s=%1$s">Применить изменения</a> ко всем существующим подписям.';
