...
$txt['allow_disableAnnounce'] = 'Разрешить пользователям отказываться от почтовых уведомлений форума';
...
// Privacy settings.
$txt['enable_privacy_userexport'] = 'Разрешить экспорт пользовательских данных';
$txt['privacy_userexport_own'] = 'Разрешить скачивание собственных данных';
$txt['privacy_userexport_any'] = 'Разрешить скачивание данных других пользователей';

// Policy
$txt['policy_management'] = 'Управление политиками';
$txt['policy_enable'] = 'Включение политики';
$txt['policy_update'] = 'Политика обновления';
$txt['policy_save'] = 'Создать новую версию';
$txt['policy_overview'] = 'Обзор политики';
$txt['policy_not_approvals'] = 'Количество не одобренных разрешений';
$txt['policy_old_approvals'] = 'Количество прежних разрешений';
$txt['policy_fresh_approvals'] = 'Количество свежих разрешений';
$txt['policy_remove_old'] = 'Применить прежнее разрешение к новой версии';
$txt['policy_current'] = 'текущая';
...
$txt['signature_settings_warning'] = 'Обратите внимание, что по умолчанию эти настройки не применяются к уже существующим подписям. <a href="' . $scripturl . '?action=admin;area=featuresettings;sa=sig;apply;%2$s=%1$s">Применить изменения</a> ко всем существующим подписям.';
