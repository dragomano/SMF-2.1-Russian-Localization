...
$txt['error_unexpected_template_call'] = 'Ошибка: неожиданный вызов для использования шаблона %1$s. Пожалуйста, скопируйте весь текст выше и передайте его разработчикам SMF, чтобы они могли разобраться с этой ошибкой.';
