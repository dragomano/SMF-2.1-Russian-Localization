...
$txt['manageposts_bbc_settings_description'] = 'Для оформления сообщений на форуме используются специальные теги в квадратных скобках. Пример: [b]дом[/b] (будет выделено жирным шрифтом).';
...
$txt['pruning_desc'] = 'Следующие опции предназначены для того, чтобы уменьшить размер журналов форума. Обычно не требуется хранить слишком старые записи.';
