...
$txt['attach_dir_desc'] = 'Создавайте новые папки или изменяйте существующие в секции ниже.<br>Чтобы создать новую новую папку в корневой папке форума, просто введите её имя. <br>Чтобы удалить папку, сотрите путь в поле ввода. Только опустые папки могут быть удалены. Чтобы удостовериться, что папка пустая, проверьте указанное в скобках количество файлов или вложенных папок.<br>Чтобы переименовать папку, просто измените её имя в поле ввода. Только папки без вложенных папок могут быть переименованы.';
