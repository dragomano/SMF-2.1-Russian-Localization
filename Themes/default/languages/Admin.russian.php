...
$txt['manageposts_bbc_settings_description'] = 'ББ-код может использоваться для оформления сообщений. Пример жирного выделения слова «дом»: [b]дом[/b]. Все ББ-теги обрамляются квадратными скобками (\'[\' и \']\').';
