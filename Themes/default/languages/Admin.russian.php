...
$txt['ban_trigger_browse_description'] = 'Здесь показаны все элементы бана, сгруппированные по IP, имени хоста, имейлу и по имени пользователя.';
...
$txt['attach_dir_desc'] = 'Создавайте новые папки или изменяйте существующие в секции ниже.<br>Чтобы создать новую новую папку в корневой папке форума, просто введите её имя. <br>Чтобы удалить папку, сотрите путь в поле ввода. Только пустые папки могут быть удалены. Чтобы удостовериться, что папка пустая, проверьте указанное в скобках количество файлов или вложенных папок.<br>Чтобы переименовать папку, просто измените её имя в поле ввода. Только папки без вложенных папок могут быть переименованы.';
...
$txt['hooks_filter_by_hook'] = 'Фильтр по хуку';
$txt['hooks_sorted_by'] = 'Сортировка';
$txt['hooks_sorted_asc'] = ' (по возрастанию)';
$txt['hooks_sorted_desc'] = ' (по убыванию)';
