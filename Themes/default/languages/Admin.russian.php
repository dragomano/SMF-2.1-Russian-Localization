...
$txt['admin_basic_settings'] = 'На этой странице можно изменить основные настройки форума.<br>Будьте очень осторожны, поскольку неправильные настройки могут привести форум в нерабочее состояние.';
...
$txt['admin_news_desc'] = 'Пожалуйста, размещайте в каждой ячейке только одну новость. Можно использовать некоторые форумные теги — такие как <span title="Жирный">[b]</span>, <span title="Наклонный">[i]</span> и <span title="Подчеркнутый">[u]</span>, а также смайлики.<br>Чтобы убрать новость, просто удалите текст в соответствующей ячейке и сохраните изменения.';
...
$txt['guest_post_no_email'] = 'Не показывать поле для ввода имейла в сообщениях гостей';
$txt['zero_for_no_limit'] = '(0 — без ограничений)';
...
$txt['dont_show_attach_under_post_sub'] = 'Включите, если не хотите чтобы вложения выводились дважды. Вложения, вставленные в сообщения, по-прежнему подчиняются лимитам и продолжают обрабатываться как обычные.';
...
$txt['attachments_desc'] = 'Здесь можно управлять вложенными файлами. Статистика по вложениям представлена ниже.';
...
$txt['agreement_not_writable'] = 'Внимание — agreement.txt не доступен для записи, любые произведённые изменения НЕ будут сохранены.';

$txt['version_check_desc'] = 'Здесь показываются текущие версии установленных файлов, а напротив — их последние версии. Если любой из этих файлов устарел, необходимо обновить его до последней версии с <a href="https://www.simplemachines.org/" target="_blank" rel="noopener">www.simplemachines.org</a>.';
...
$txt['ban_on_email'] = 'Бан по имейлу (пример *@badsite.com)';
...
$txt['ban_add_notes'] = '<strong>Примечание</strong>: после создания бана в него можно добавить дополнительные параметры, такие как IP, имя хоста, имейл.';
...
$txt['ban_trigger_browse_description'] = 'Здесь отображаются все элементы бана, сгруппированные по IP, имени хоста, имейлу и по имени пользователя.';

$txt['ban_log'] = 'Журнал банов';
$txt['ban_log_description'] = 'Здесь отображены все попытки заблокированных пользователей зайти на форум (баны типа «полный бан» и «без возможности зарегистрироваться»).';
$txt['ban_log_no_entries'] = 'Записей не найдено.';
$txt['ban_log_ip'] = 'IP-адрес';
$txt['ban_log_email'] = 'Имейл';
...
$txt['spider_log_desc'] = 'Обзор записей, относящихся к деятельности поисковых ботов на данном форуме.';
$txt['log_settings_desc'] = 'Используйте эти опции для настройки логирования на вашем форуме.';
$txt['modlog_enabled'] = 'Включить журнал действий модераторов';
$txt['adminlog_enabled'] = 'Включить журнал действий администраторов';
$txt['userlog_enabled'] = 'Включить журнал редактирования профилей';
...
$txt['errorlog_desc'] = 'Журнал ошибок содержит записи обо всех обнаруженных в работе форума ошибках.<br>Для удаления конкретной записи выберите её и нажмите кнопку «Удалить выделенные».';
...
$txt['support_versions_server'] = 'Версия веб-сервера';
...
$txt['attachment_manager_thumbs'] = 'Миниатюры';
...
$txt['attachment_manager_thumbs_no_entries'] = 'Миниатюр нет.';
...
$txt['attachmentShowImages'] = 'Отображать миниатюры вложений под сообщениями';
...
$txt['attachment_ini_max'] = 'Максимальный размер, заданный в php.ini: %1$s';
...
$txt['attachmentThumbnails'] = 'Изменять размер изображений при отображении под сообщениями';
...
$txt['attachmentThumbWidth'] = 'Максимальная ширина миниатюры';
$txt['attachmentThumbHeight'] = 'Максимальная высота миниатюры';
...
$txt['attach_dir_desc'] = 'Создавайте новые папки или изменяйте существующие в секции ниже.<br>Чтобы создать новую папку в корневой папке форума, введите её имя.<br>Чтобы удалить папку, сотрите путь в поле ввода. Только пустые папки могут быть удалены.<br>Чтобы удостовериться, что папка пустая, проверьте указанное в скобках количество файлов или вложенных папок.<br>Чтобы переименовать папку, просто измените её имя в поле ввода. Только папки без вложенных папок могут быть переименованы.';
$txt['attach_dir_base_desc'] = 'Здесь можно изменить базовую папку или создать новую. Новые базовые директории будут добавлены в список папок вложений.';
...
$txt['attach_current_size'] = 'Размер (КБ)';
...
$txt['max_image_height'] = 'Максимальная высота вложенных или вставленных изображений';
...
$txt['option_css_resize'] = 'Изменить размер средствами браузера';
...
$txt['custom_avatar_dir_wrong'] = 'Папка для аватаров указана неверно. Аватары не будут работать должным образом.';
$txt['custom_avatar_dir'] = 'Папка загрузки';
$txt['custom_avatar_dir_desc'] = 'Должна иметь права на запись и не овпадать с папкой на сервере.';
...
$txt['gravatarAllowExtraEmail'] = 'Разрешить использование дополнительного имейла для граватара?';
...
$txt['gravatarDefault'] = 'Выберите стиль по умолчанию, когда у пользователя нет привязанного граватара';
$txt['gravatar_mm'] = 'Статичный силуэт человека в мультяшном стиле';
$txt['gravatar_identicon'] = 'Сгенерированный геометрический узор';
$txt['gravatar_monsterid'] = 'Сгенерированный монстр с разными цветами, лицами и другими чертами';
$txt['gravatar_wavatar'] = 'Сгенерированные лица с различными чертами и фоном';
$txt['gravatar_retro'] = 'Сгенерированные потрясающие пиксельные лица в стиле 8-битных аркад';
$txt['gravatar_blank'] = 'Статическое прозрачное PNG изображение';
...
$txt['attach_repair_missing_thumbnail_parent'] = 'Миниатюр, не ассоциированных со своими полноразмерными изображениями: %1$d';
$txt['attach_repair_parent_missing_thumbnail'] = 'Изображений без миниатюр: %1$d';
...
$txt['xmlnews_maxlen'] = 'Максимальная длина сообщения:<div class="smalltext">(0 — без ограничений, но это плохая идея)</div>';
$txt['xmlnews_maxlen_note'] = '(0 — отключить ограничения, но это плохая идея.)';
...
$txt['manageposts_bbc_settings'] = 'Теги форума';
$txt['manageposts_bbc_settings_description'] = 'Для оформления сообщений на форуме используются специальные теги в квадратных скобках. Пример: [b]дом[/b] отобразится как <strong>дом</strong>.';
$txt['manageposts_bbc_settings_title'] = 'Настройки форумных тегов';
...
$txt['quote_expand'] = 'Минимальная высота цитаты для добавления ссылки расширения';
$txt['quote_expand_pixels_units'] = 'px';
...
$txt['subject_toggle'] = 'Показывать заголовки сообщений';
$txt['show_profile_buttons'] = 'Показывать кнопку перехода в профиль пользователя под сообщениями';
$txt['show_modify'] = 'Показывать дату последнего редактирования сообщения';

$txt['enableBBC'] = 'Разрешить форумные теги';
$txt['enablePostHTML'] = 'Разрешить <em>основной</em> HTML в сообщениях';
$txt['autoLinkUrls'] = 'Автоматически вставлять ссылки URL';
$txt['disabledBBC'] = 'Разрешенные теги';
$txt['legacyBBC'] = 'Устаревшие теги';
$txt['bbcTagsToUse'] = 'Разрешить теги форума';
...
$txt['enableAllMessages'] = 'Максимальный размер темы для отображения всех сообщений сразу';
...
$txt['enablePreviousNext'] = 'Показывать ссылки «Назад/Далее»';
...
$txt['admin_news_select_email'] = 'Имейл';
...
$txt['mailqueue_test'] = 'Тестовая отправка';
...
$txt['pruning_desc'] = 'Следующие опции предназначены для уменьшения размера журналов форума. Обычно не требуется хранить слишком старые записи.';
$txt['log_settings'] = 'Настройка журналов';
...
$txt['spiders'] = 'Поисковые боты';
$txt['spider_logs'] = 'Журнал поисковых ботов';
...
$txt['hooks_field_included_file'] = 'Подключаемый файл';
...
$txt['hooks_disable_instructions'] = 'Нажмите на иконку статуса, чтобы включить или выключить хук.';
